...
class PaginasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pagina" do
    assert_difference('Pagina.count') do
      post paginas_url, params: { pagina: { title: @pagina.title, description: @pagina.description, body: @pagina.body, author: @pagina.author } }
    end
  ...
  test "should update pagina" do
    patch pagina_url(@pagina), params: { pagina: { title: @pagina.title, description: @pagina.description, body: @pagina.body, author: @pagina.author } }
